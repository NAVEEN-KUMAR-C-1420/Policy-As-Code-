...
def get_current_global_version():
    ...
    return BaseAPIResponse(
        success=True if data else False, message="Success" if data else "No active version", data=data
    )
...
def get_global_version(version_number: int):
    ...
    return BaseAPIResponse(
        success=True if data else False, message="Success" if data else "Version not found", data=data
    )
